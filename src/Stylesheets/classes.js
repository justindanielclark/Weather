const classes = {
  ...
  weatherDisplay: {
    ...
    forecastContainer: 'flex flex-col',
    forecastTitle: 'text-xl font-bold w-full border-neutral-100 border-b-2 mb-2',
    forecastSlider: 'flex flex-row',
    forecastSliderLabels: 'flex flex-col',
    forecastSliderContainer: 'w-full overflow-x-auto',
    forecastSlide: 'flex flex-col border-zinc-900 border-r-2 last:border-r-0',
    forecastInfo: 'text-sm w-20 h-9 px-2 odd:bg-zinc-700 flex items-center justify-end',
    forecastInfoImg: 'px-2 py-1 h-20',
    forecastInfoTimeDisplay: 'text-sm w-full text-center font-bold bg-zinc-900 text-neutral-100',
  },
  citiesDisplay: {
