const classes = {
  ...
  weatherDisplay: {
    ...
    forecastSlider: 'flex flex-row w-full overflow-x-auto',
    forecastSlide: 'flex flex-col border-zinc-700 border-r last:border-r-0',
    forecastInfo: 'text-sm w-20 text-right px-2 py-1 odd:bg-zinc-700',
